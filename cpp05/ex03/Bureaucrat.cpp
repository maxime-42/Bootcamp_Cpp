...
{
	form.beSigned(*this);
	if (form.getBoolSigned() == true)
		std::cout << "Bureaucrat : <" << this->_name  << "> signs Form : <" << form.getName() << ">" << std::endl;
	else
	{
		std::cout << "Bureaucrat : <" << this->_name << "> cannot sign Form : <" << form.getName() << ">" << std::endl;
...
void Bureaucrat::executeForm(Form const & form)
{
	if (form.getBoolSigned() == true)
	{
		...
		std::cout << "The form should be signed befor executing"  << std::endl;
}
